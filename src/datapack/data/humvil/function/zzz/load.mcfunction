...
scoreboard objectives add humvil.health dummy
scoreboard objectives add humvil.health_check dummy

# Tags:
tag @e remove humvil.uninstall.not_this
...
tellraw @a [{"text":"[HUMVIL] ","color":"yellow"},{"text":"Humanoid Villagers","underlined":true,"color":"gold","click_event":{"action":"open_url","url":"https://modrinth.com/datapack/humanoid-villagers"}}," ",{"text":"(v1.0.2)","underlined":true,"color":"green","click_event":{"action":"open_url","url":"https://modrinth.com/datapack/humanoid-villagers/changelog"},"hover_event":{"action":"show_text","value":[{"translate":"load.humvil.message.5"}]}},{"text":" - ","color":"gray"},{"translate":"load.humvil.message.4","color":"blue"},{"text":"☽ Eclipse Studios","underlined":true,"color":"blue","click_event":{"action":"open_url","url":"https://www.youtube.com/@EclipseStudiosMC"}}]
