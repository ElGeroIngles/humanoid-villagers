...
execute if entity @s[tag=humvil.uninstall.not_this] run return fail
...
attribute @s minecraft:scale modifier add humvil:cover_human_hitbox 0.025641 add_multiplied_base
